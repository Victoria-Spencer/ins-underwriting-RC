...
CREATE TABLE `t_antiselection_record`  (
  ...
  UNIQUE INDEX `idx_trace_id`(`trace_id` ASC) USING BTREE COMMENT 'trace_id索引'
...
CREATE TABLE `t_policy_holder`  (
  ...
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE COMMENT '创建时间索引'
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '投保人核心信息表' ROW_FORMAT = Dynamic;
...
INSERT INTO `t_policy_holder` VALUES (3, 'allen', '350304200002020121', 27, '消防员', '健康', '15759233345', '健康保险', '2026-03-21 19:12:06', '2026-03-21 19:12:06', 0, NULL);
...
CREATE TABLE `t_pricing_record`  (
  ...
  UNIQUE INDEX `idx_trace_id`(`trace_id` ASC) USING BTREE COMMENT 'trace_id索引'
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '保费定价记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_pricing_record
-- ----------------------------
INSERT INTO `t_pricing_record` VALUES (1, 3, '760fe036788140eeafce38534581ddc3', 7, 4592014.500000, 5669149.570000, '2026-03-22 20:48:51', '2027-03-21 20:48:51', '2026-03-21 20:48:51');
...
CREATE TABLE `t_risk_decision_record`  (
  ...
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE COMMENT '创建时间索引',
  UNIQUE INDEX `idx_trace_id`(`trace_id` ASC) USING BTREE COMMENT 'trace_id索引'
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '风控决策记录表（金融审计核心）' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_risk_decision_record
-- ----------------------------
INSERT INTO `t_risk_decision_record` VALUES (1, 1, '0795ebf9977c498eb3577d3a70e6d185', 1, 0.281654, NULL, 0.281654, '承保', '投保保额1000000.99元（高风险），其他风险因素均为低/中等，0.281654，承保', '2026-03-21 19:05:35');
INSERT INTO `t_risk_decision_record` VALUES (2, 1, '6816649dd2eb41348281feabb2d4754d', 1, 0.281654, NULL, 0.281654, '承保', '投保保额1000000.99元（高风险），其他风险因素均为低/中等，0.281654，承保', '2026-03-21 19:06:00');
INSERT INTO `t_risk_decision_record` VALUES (3, 1, '0ec811a53aa544f99545017183bdfd59', 1, 0.281654, NULL, 0.281654, '承保', '投保保额1000000.99元（高风险），其他风险因素均为低/中等，0.281654，承保', '2026-03-21 19:09:19');
INSERT INTO `t_risk_decision_record` VALUES (5, 3, '760fe036788140eeafce38534511ddc3', 1, 0.408740, 0.408740, 0.408740, '承保', '职业、保额风险值较高，年龄健康风险较低整体可控，0.408740，承保', '2026-03-21 20:22:04');
INSERT INTO `t_risk_decision_record` VALUES (8, 3, '8171c17ab819403ab4ccf16cdb3c816c', 1, 0.370709, 0.500000, 0.500000, '承保', 'AI复查：风险概率0.5，建议承保', '2026-03-22 08:45:45');
INSERT INTO `t_risk_decision_record` VALUES (9, 3, 'db5e002643fb435692f50c3bbe404222', 1, 0.370709, 0.500000, 0.500000, '承保', 'AI复查：风险概率0.5，建议承保', '2026-03-22 08:51:09');
...
CREATE TABLE `t_risk_factor_record`  (
  ...
  UNIQUE INDEX `idx_trace_id`(`trace_id` ASC) USING BTREE COMMENT 'trace_id索引（快速查询单次流程）'
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '风险因子计算记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_risk_factor_record
-- ----------------------------
INSERT INTO `t_risk_factor_record` VALUES (1, 1, '1f6f432168364449a098fa4b80a154bd', 0.100000, 0.100000, 0.123456, 0.700000, 1.000000, '2026-03-21 17:37:04', 'system');
INSERT INTO `t_risk_factor_record` VALUES (2, 1, '748e0b3b1577435f8242f31e973b007b', 0.100000, 0.100000, 0.123456, 0.700000, 0.287037, '2026-03-21 17:39:01', 'system');
INSERT INTO `t_risk_factor_record` VALUES (3, 1, '48f5ec5b82a44eeab95d17f05aebf545', 0.100000, 0.100000, 0.123456, 0.700000, 0.287037, '2026-03-21 18:57:44', 'system');
INSERT INTO `t_risk_factor_record` VALUES (4, 1, 'c46eb13d7d504215be7653d3c96f66c2', 0.100000, 0.100000, 0.123456, 0.700000, 0.287037, '2026-03-21 19:05:17', 'system');
INSERT INTO `t_risk_factor_record` VALUES (5, 1, '50f8e3b44cba47f2a37c19af62ba857d', 0.100000, 0.100000, 0.123456, 0.700000, 0.287037, '2026-03-21 19:09:01', 'system');
INSERT INTO `t_risk_factor_record` VALUES (6, 3, '760fe036788140eeafce38534581ddc3', 0.100000, 0.900000, 0.123456, 0.900000, 0.507037, '2026-03-21 19:12:32', 'system');
INSERT INTO `t_risk_factor_record` VALUES (7, 3, '8171c17ab819403ab4ccf16cdb3c816c', 0.100000, 0.900000, 0.123456, 0.700000, 0.447037, '2026-03-22 08:45:25', 'system');
INSERT INTO `t_risk_factor_record` VALUES (8, 3, 'db5e002643fb435692f50c3bbe404222', 0.100000, 0.900000, 0.123456, 0.700000, 0.447037, '2026-03-22 08:50:54', 'system');
...
CREATE TABLE `t_underwriting_record`  (
  ...
  `trace_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '全链路追踪ID',
  `risk_decision_id` bigint NOT NULL COMMENT '关联风控决策记录ID（t_risk_decision_record.id）',
  `pricing_record_id` bigint NULL DEFAULT NULL COMMENT '关联保费定价记录ID（t_pricing_record.id）',
